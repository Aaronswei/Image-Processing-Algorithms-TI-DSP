...
void main(void)
{
	...
	Input_Image();
	Gray_Image('Y');
	Gray_Image_Quantization('Y', 8);
	Gray_Image_Quantization('Y', 7);
	Gray_Image_Quantization('Y', 6);
	Gray_Image_Quantization('Y', 5);
	Gray_Image_Quantization('Y', 4);
	Gray_Image_Quantization('Y', 3);
	Gray_Image_Quantization('Y', 2);
	Gray_Image_Quantization('Y', 1);
	/*
	Filter('L');
	Filter('H');
	Filter('B');
